...
namespace Common
{
    ...
    public class PersistenceStorageObjectMappings : IPersistenceStorageObjectMappings
    {
        ...
        public PersistenceStorageObjectMappings()
        {
            ...
            _mappings.Add(typeof(Bookstore.Codes), new Bookstore_Codes_Mapper());
    ...
    public class Bookstore_Book_Mapper : IPersistenceStorageObjectMapper
    {
        public PersistenceStorageObjectParameter[] GetParameters(IEntity genericEntity)
        {
            ...
            return new PersistenceStorageObjectParameter[]
            {
                ...
                new PersistenceStorageObjectParameter("UpdatedAt", new SqlParameter("", System.Data.SqlDbType.DateTime2) { Value = ((object)entity.UpdatedAt) ?? DBNull.Value, Scale = 3 }),
                new PersistenceStorageObjectParameter("AssignedToID", new SqlParameter("", System.Data.SqlDbType.UniqueIdentifier) { Value = ((object)entity.AssignedToID) ?? DBNull.Value }),
    ...
    public class Bookstore_Codes_Mapper : IPersistenceStorageObjectMapper
    {
        public PersistenceStorageObjectParameter[] GetParameters(IEntity genericEntity)
        {
            var entity = (Bookstore.Codes)genericEntity;
            return new PersistenceStorageObjectParameter[]
            {
                new PersistenceStorageObjectParameter("ID", new SqlParameter("", System.Data.SqlDbType.UniqueIdentifier) { Value = entity.ID }),
                new PersistenceStorageObjectParameter("Code", new SqlParameter("", System.Data.SqlDbType.NVarChar) { Value = ((object)entity.Code) ?? DBNull.Value }),
                ...
                /*DataStructureInfo PersistenceStorageMapperPropertyMapping Bookstore.Codes*/
            };
        }
        ...
        {
            var entity = (Bookstore.Codes)genericEntity;
            /*DataStructureInfo PersistenceStorageMapperDependencyResolution Bookstore.Codes*/
            yield break;
        }
    
    	public string GetTableName()
        {
            return "Bookstore.Codes";
        }
    }
    ...
    public class Bookstore_Comment_Mapper : IPersistenceStorageObjectMapper
    {
        public PersistenceStorageObjectParameter[] GetParameters(IEntity genericEntity)
        {
            ...
            return new PersistenceStorageObjectParameter[]
            {
                ...
                new PersistenceStorageObjectParameter("Modified", new SqlParameter("", System.Data.SqlDbType.DateTime2) { Value = ((object)entity.Modified) ?? DBNull.Value, Scale = 3 }),
    ...
    public class Bookstore_Education_Mapper : IPersistenceStorageObjectMapper
    {
        public PersistenceStorageObjectParameter[] GetParameters(IEntity genericEntity)
        {
            ...
            {
                new PersistenceStorageObjectParameter("ID", new SqlParameter("", System.Data.SqlDbType.UniqueIdentifier) { Value = entity.ID }),
                new PersistenceStorageObjectParameter("DateOfEducation", new SqlParameter("", System.Data.SqlDbType.DateTime2) { Value = ((object)entity.DateOfEducation) ?? DBNull.Value, Scale = 3 }),
                new PersistenceStorageObjectParameter("Description", new SqlParameter("", System.Data.SqlDbType.NVarChar) { Value = ((object)entity.Description) ?? DBNull.Value }),
    ...
    public class Bookstore_Employee_Mapper : IPersistenceStorageObjectMapper
    {
        public PersistenceStorageObjectParameter[] GetParameters(IEntity genericEntity)
        {
            ...
            return new PersistenceStorageObjectParameter[]
            {
                ...
                new PersistenceStorageObjectParameter("MobileNumber", new SqlParameter("", System.Data.SqlDbType.NVarChar) { Value = ((object)entity.MobileNumber) ?? DBNull.Value }),
                new PersistenceStorageObjectParameter("Modified", new SqlParameter("", System.Data.SqlDbType.DateTime2) { Value = ((object)entity.Modified) ?? DBNull.Value, Scale = 3 }),
                new PersistenceStorageObjectParameter("Name", new SqlParameter("", System.Data.SqlDbType.NVarChar) { Value = ((object)entity.Name) ?? DBNull.Value }),
                ...
                new PersistenceStorageObjectParameter("VAT", new SqlParameter("", System.Data.SqlDbType.Int) { Value = ((object)entity.VAT) ?? DBNull.Value }),
    ...
    public class Bookstore_Manager_Mapper : IPersistenceStorageObjectMapper
    {
        public PersistenceStorageObjectParameter[] GetParameters(IEntity genericEntity)
        {
            ...
            {
                new PersistenceStorageObjectParameter("ID", new SqlParameter("", System.Data.SqlDbType.UniqueIdentifier) { Value = entity.ID }),
                new PersistenceStorageObjectParameter("BonusInformation", new SqlParameter("", System.Data.SqlDbType.NVarChar) { Value = ((object)entity.BonusInformation) ?? DBNull.Value }),
    ...
    public class Bookstore_Review_Mapper : IPersistenceStorageObjectMapper
    {
        public PersistenceStorageObjectParameter[] GetParameters(IEntity genericEntity)
        {
            ...
            return new PersistenceStorageObjectParameter[]
            {
                new PersistenceStorageObjectParameter("ID", new SqlParameter("", System.Data.SqlDbType.UniqueIdentifier) { Value = entity.ID }),
                new PersistenceStorageObjectParameter("BookID", new SqlParameter("", System.Data.SqlDbType.UniqueIdentifier) { Value = ((object)entity.BookID) ?? DBNull.Value }),
                new PersistenceStorageObjectParameter("Score", new SqlParameter("", System.Data.SqlDbType.Int) { Value = ((object)entity.Score) ?? DBNull.Value }),
                new PersistenceStorageObjectParameter("Text", new SqlParameter("", System.Data.SqlDbType.NVarChar) { Value = ((object)entity.Text) ?? DBNull.Value }),
